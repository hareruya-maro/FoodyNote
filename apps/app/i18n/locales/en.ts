export default {
    ...
    analysis: {
        ...
        noData: "No correlation data found based on current history.",
        topCandidates: "Top Candidates",
        allRiskFactors: "Overall Risk Factors",
        filteredRiskFactors: "{{type}} Risk Factors",
        axisRisk: "Risk %",
        axisFreq: "Frequency",
        highRiskZone: "High Priority",
        tabRanking: "Trigger Ranking",
        tabMap: "Risk Map",
        filterBySymptom: "Filter by Symptom:",
        triggerFoundTitle: "Trigger Found",
        noDataTitle: "Not enough data yet.",
        noDataDesc: "Keep recording meals and symptoms to find patterns.",
        insight: "Your data suggests...",
        detectiveTitle: "AI Detective",
        agentStatus: {
            analyst: "Analyst Agent is scanning...",
            researcher: "Researcher Agent is checking...",
            writer: "Writer Agent is drafting...",
        },
        ...
        discoverDescription: "Let our AI Agents investigate...",
        startInvestigation: "Start Investigation",
        history: "Analysis History",
        noHistory: "No analysis history yet",
        historyHint: "Run an analysis...",
    ...
    doctor: {
        ...
        defaultHeadline: "Analysis Complete",
        proposal: "Actionable Advice",
        hideDetails: "Hide Detailed Insights",
        showDetails: "Show Detailed Insights",
